import AdditionalExpenses from '../finance_Model/finance_AdditionalExpensesModel.js';
...
const getAllAdditionalExpenses = async (req, res) => {
  try {
    ...
    const additionalExpenses = await AdditionalExpenses.find().sort({ createdAt: -1 });
