...
import { RawMilk } from '../Inventorytypes/inventoryTypes';
import { rawMilkService } from '../Inventoryservices/inventoryApi';
import InventoryRawMilkForm from '../Inventorycomponents/InventoryRawMilkForm';
