            ...
            <div className="form-group">
              ...
              >
                ...
                {pendingCollections.map((collection: MilkCollection) => {
                  ...
                  const valueTotal = collection.totalValue || (collection.quantity || 0) * (collection.paymentAmount || 0);
                  return (
                    <option key={collection._id} value={collection._id}>
                      {collection.collectionId} - {farmerName} - {formatDate(collection.collectionDate)} - {formatCurrency(valueTotal)}
                    </option>
                  );
                })}
              </select>
              ...
              <div className="collection-details-box">
                ...
                <div className="details-grid">
                  ...
                  <div className="detail-item">
                    ...
                    <p>{selectedCollection.quantity} L</p>
                  </div>
                  <div className="detail-item">
                    <label>Rate/Liter:</label>
                    <p>{formatCurrency(selectedCollection.paymentAmount)}</p>
                  </div>
                  <div className="detail-item highlight">
                    <label>Total Value:</label>
                    <p className="amount-highlight">{formatCurrency(selectedCollection.totalValue || (selectedCollection.quantity * (selectedCollection.paymentAmount || 0)))}</p>
                  </div>
                </div>
              </div>
            )}
